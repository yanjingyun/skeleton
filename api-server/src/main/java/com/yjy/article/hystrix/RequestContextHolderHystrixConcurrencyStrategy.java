package com.yjy.article.hystrix;
...
public class RequestContextHolderHystrixConcurrencyStrategy extends HystrixConcurrencyStrategy {
	...
	public ThreadPoolExecutor getThreadPool(HystrixThreadPoolKey threadPoolKey,
		...
		return delegate != null ? delegate.getThreadPool(threadPoolKey, threadPoolProperties)
	...
	public <T> Callable<T> wrapCallable(Callable<T> callable) {
		...
		RequestContextHolderCallable<T> delegatingCallable = new RequestContextHolderCallable<>(callable,
				requestAttributes);
