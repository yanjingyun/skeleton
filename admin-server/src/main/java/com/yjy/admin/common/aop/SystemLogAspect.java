package com.yjy.admin.common.aop;
...
import com.yjy.admin.common.annotation.SystemLog;
import com.yjy.admin.common.utils.IpInfoUtil;
import com.yjy.admin.common.utils.ThreadPoolUtil;
import com.yjy.admin.module.sys.entity.AdminLog;
import com.yjy.admin.module.sys.service.IAdminLogService;
...
public class SystemLogAspect {
	...
	/**
	 * 多线程时，ThreadLocal，为每个线程保存线程内能访问的数据，通过ThreadLocal各个线程只能获取自身对应的数据， 不能访问其他线程的数据
	 */
	...
	@Pointcut("@annotation(com.yjy.admin.common.annotation.SystemLog)")
